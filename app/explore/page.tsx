...
export default function Explore() {
    ...
    const filteredSkills = availableSkills.filter((skill) => {
        const matchesSearch = skill.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
            skill.authorName.toLowerCase().includes(searchQuery.toLowerCase());
                        ...
                        <div className="flex-grow flex">
                            <div className="relative flex-grow">
                                <input
                                    ...
                                    className="w-full bg-slate-900 border border-slate-700 rounded-l-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-slate-100 placeholder-slate-500"
                                />
                            </div>
                            <button className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-3 rounded-r-lg font-bold transition-colors">
                                Search
                            </button>
                        </div>
                    </div>
